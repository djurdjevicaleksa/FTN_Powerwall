...
#define MAX_DEVICES 10  //promenjeno
#define MAX_SENZORI 3
#define MAX_AKTUATORI 3
#define MAX_KONTROLERI 3
...
char* allowedDevices[MAX_DEVICES] = {"Senzor1", "Aktuator1", "Kontroler1", "Senzor2", "Aktuator2", "Kontroler2"};

static Device* groupSenzori[MAX_SENZORI] = {NULL};
static Device* groupAktuatori[MAX_AKTUATORI] = {NULL};
static Device* groupKontroleri[MAX_KONTROLERI] = {NULL};
...
void printGroups(struct mosquitto*);
